...
<body class="font-sans text-base font-normal text-gray-600 dark:text-gray-400 dark:bg-gray-800">
  ...
  <header>
    ...
    <nav class="flex flex-row flex-nowrap items-center justify-between mt-0 py-4 px-6 border-b border-gray-200 bg-white dark:bg-gray-800 dark:border-gray-800" id="desktop-menu">
      ...
      <ul class="flex ltr:ml-auto rtl:mr-auto mt-2 mt-0">
              ...
              <nav id="mobile-nav" class="flex flex-col ltr:right-0 rtl:left-0 w-72 fixed top-0 bg-white dark:bg-gray-800 h-full overflow-auto z-40 scrollbars show" x-show="open" @click.away="open=false" x-description="Mobile menu" role="menu" aria-orientation="vertical" aria-labelledby="navbartoggle" x-transition:enter="transform transition-transform duration-300" x-transition:enter-start="ltr:translate-x-full rtl:-translate-x-full" x-transition:enter-end="translate-x-0" x-transition:leave="transform transition-transform duration-300" x-transition:leave-start="translate-x-0" x-transition:leave-end="ltr:translate-x-full rtl:-translate-x-full">
                ...
                <div class="pt-6 px-6">
                  <div x-data="{ open: true }" x-show="open" class="flex justify-between items-center relative bg-yellow-100 text-yellow-900 p-3 rounded-lg mb-4">
                    <div>
                      How to apply? please read the documentation on <a href="https://taildash.tailwinddashboard.com/authentication/docs/customize.html" class="underline font-semibold">Customize page</a>
                    </div>
        ...
        <li class="relative">
          <a href="login-basic.html" class="block py-3 px-4 flex hover:text-indigo-500 focus:outline-none">
            <div class="relative inline-block">Login</div>
          </a>
        </li>
        <li class="relative">
          <a href="register-basic.html" class="block py-3 px-4 flex hover:text-indigo-500 focus:outline-none">
  ...
  <main>
	  <!-- =========={ register }==========  -->
	  <div id="register-area" class="relative py-12 bg-gray-100 dark:bg-gray-900 dark:bg-opacity-40">
	          ...
	          <div class="relative">
	            <div class="p-6 sm:py-8 sm:px-12 rounded-lg bg-white dark:bg-gray-800 shadow-xl">
	              <form id="register-form">
	                <h1 class="text-2xl leading-normal mb-6 font-bold text-gray-800  dark:text-gray-300 text-center">Register</h1>
	                <hr class="block w-12 h-0.5 mx-auto my-5 bg-gray-700 border-gray-700">
	                <div class="mb-6">
                    <input name="name" class="w-full leading-5 relative py-2 px-4 rounded text-gray-800 bg-white border border-gray-300 overflow-x-auto focus:outline-none focus:border-gray-400 focus:ring-0 dark:text-gray-300 dark:bg-gray-700 dark:border-gray-700 dark:focus:border-gray-600" placeholder="Full Name" value="" aria-label="full name" type="text" required="">
                  </div>
                  <div class="mb-6">
                    <input name="email" class="w-full leading-5 relative py-2 px-4 rounded text-gray-800 bg-white border border-gray-300 overflow-x-auto focus:outline-none focus:border-gray-400 focus:ring-0 dark:text-gray-300 dark:bg-gray-700 dark:border-gray-700 dark:focus:border-gray-600" placeholder="Email address" value="" aria-label="email" type="email" required="">
                  </div>
                  <div class="mb-6">
                  ...
                  <div class="mb-6">
                    <input class="w-full leading-5 relative py-2 px-4 rounded text-gray-800 bg-white border border-gray-300 overflow-x-auto focus:outline-none focus:border-gray-400 focus:ring-0 dark:text-gray-300 dark:bg-gray-700 dark:border-gray-700 dark:focus:border-gray-600" placeholder="Repeat Password" aria-label="repeat password" type="password" value="" required="">
                  </div>
                  <div class="mb-6">
                    <input class="form-checkbox h-5 w-5 text-indigo-500 dark:bg-gray-700 border border-gray-300 dark:border-gray-700 rounded focus:outline-none" type="checkbox" value="" id="terms" required>
	              ...
	              <div class="mt-3">
	                ...
	                <div class="text-center mb-4 sm:space-x-4">
	                  <a class="py-2 px-4 block sm:inline-block rounded leading-5 text-gray-100 bg-indigo-900 border border-indigo-900 hover:text-white hover:opacity-90 hover:ring-0 hover:border-indigo-900 focus:bg-indigo-900 focus:border-indigo-800 focus:outline-none focus:ring-0 mb-3" href="register-basic.html#">
	                  ...
	                  <a class="py-2 px-4 block sm:inline-block rounded leading-5 text-gray-100 bg-indigo-500 border border-indigo-500 hover:text-white hover:bg-indigo-600 hover:ring-0 hover:border-indigo-600 focus:bg-indigo-600 focus:border-indigo-600 focus:outline-none focus:ring-0 mb-3" href="register-basic.html#">
	                ...
	                <p class="text-center mb-4">Already have an account?  <a class="hover:text-indigo-500" href="login-basic.html">Login</a></p>
	              </div>
	            </div>
	          </div>
	        </div>
        ...
        <div class="flex-shrink max-w-full px-4 w-full md:w-1/2 text-center md:ltr:text-left md:rtl:text-right">
          <ul class="ltr:pl-0 rtl:pr-0">
            <li class="inline-block ltr:mr-3 rtl:ml-3">
              <a class="hover:text-indigo-500" href="register-basic.html#">Support</a>
            </li>
            <li class="inline-block ltr:mr-3 rtl:ml-3">
              <a class="hover:text-indigo-500" href="register-basic.html#">Help Center</a>
            </li>
            <li class="inline-block ltr:mr-3 rtl:ml-3">
              <a class="hover:text-indigo-500" href="register-basic.html#">Privacy</a>
            </li>
            <li class="inline-block ltr:mr-3 rtl:ml-3">
              <a class="hover:text-indigo-500" href="register-basic.html#">Terms of Service</a>
            </li>
          </ul>
        </div>

...
<body class="font-sans text-base font-normal text-gray-600 dark:text-gray-400 dark:bg-gray-800">
                ...
                <div class="p-6 sm:py-8 sm:px-12 rounded-lg bg-white dark:bg-gray-800 shadow-xl">
                  ...
                  <div class="mt-4">
                    ...
                    <div class="text-center mb-6 sm:space-x-4">
                      <a class="p-2 block sm:inline-block rounded lg:rounded-full leading-5 text-gray-100 bg-indigo-900 border border-indigo-900 hover:text-white hover:opacity-90 hover:ring-0 hover:border-indigo-900 focus:bg-indigo-900 focus:border-indigo-800 focus:outline-none focus:ring-0 mb-3" href="login-ilustration.html#">
                      ...
                      <a class="p-2 block sm:inline-block rounded lg:rounded-full leading-5 text-gray-100 bg-indigo-500 border border-indigo-500 hover:text-white hover:bg-indigo-600 hover:ring-0 hover:border-indigo-600 focus:bg-indigo-600 focus:border-indigo-600 focus:outline-none focus:ring-0 mb-3" href="login-ilustration.html#">
          ...
          <div class="flex-shrink max-w-full px-4 w-full lg:w-1/2">
             <div class="text-center mt-6 lg:mt-0">
              ...
              <div class="px-4 mt-12">
                ...
                <p class="text-base text-lg mb-4 text-gray-500">Managing a business is not as easy as it is today. You can view and manage all reports in a simple and practical way.</p>
               </div>
             </div>
          </div>
        </div>
  ...
  <footer class="bg-white py-6 border-t border-gray-200 dark:bg-gray-800 dark:border-gray-800">
    <div class="container mx-auto px-4 xl:max-w-6xl ">
          ...
          <div class="flex-shrink max-w-full px-4 w-full md:w-1/2 text-center md:ltr:text-left md:rtl:text-right">
            <ul class="ltr:pl-0 rtl:pr-0">
              <li class="inline-block ltr:mr-3 rtl:ml-3">
                <a class="hover:text-indigo-500" href="login-ilustration.html#">Support</a>
              </li>
              <li class="inline-block ltr:mr-3 rtl:ml-3">
                <a class="hover:text-indigo-500" href="login-ilustration.html#">Help Center</a>
              </li>
              <li class="inline-block ltr:mr-3 rtl:ml-3">
                <a class="hover:text-indigo-500" href="login-ilustration.html#">Privacy</a>
              </li>
              <li class="inline-block ltr:mr-3 rtl:ml-3">
                <a class="hover:text-indigo-500" href="login-ilustration.html#">Terms of Service</a>
              </li>
            </ul>
          </div>

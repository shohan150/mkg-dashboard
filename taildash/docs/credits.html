    ...
    <nav id="sidebar-menu" x-description="Mobile menu" x-bind:aria-expanded="open" :class="{ 'w-64 md:w-0': open, 'w-0 md:w-64': !(open) }" class="fixed w-64 transition-all duration-500 ease-in-out h-screen bg-white dark:bg-gray-800 shadow-sm">
      <div class="h-full overflow-y-auto scrollbars">
        ...
        <div class="mh-18 text-center py-5">
          <a href="credits.html#" class="relative">
        ...
        <!-- Sidebar menu -->
        <ul id="side-menu" x-data="{selected:9}" class="w-full float-none flex flex-col font-medium ltr:pl-1.5 rtl:pr-1.5">
          <!-- dropdown -->
          <li class="relative">
          ...
          <li class="relative">
            ...
            <ul x-show="selected == 9" x-transition:enter="transition-all duration-200 ease-out" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" class="block rounded rounded-t-none top-full z-50 ltr:pl-7 rtl:pr-7 py-0.5 ltr:text-left rtl:text-right mb-1 font-normal">
              <li class="relative">
                <a class="block w-full py-2 px-6 clear-both whitespace-nowrap hover:text-indigo-500 dark:hover:text-gray-300" href="introduction.html">Introduction</a>
              </li>
              <li class="relative">
                <a class="block w-full py-2 px-6 clear-both whitespace-nowrap hover:text-indigo-500 dark:hover:text-gray-300" href="tools.html">Tools</a>
              </li>
              <li class="relative">
                <a class="block w-full py-2 px-6 clear-both whitespace-nowrap hover:text-indigo-500 dark:hover:text-gray-300" href="customize.html">Customize</a>
              </li>
              <li class="relative">
                <a class="block w-full py-2 px-6 clear-both whitespace-nowrap hover:text-indigo-500 dark:hover:text-gray-300" href="rtl.html">RTL Direction</a>
              </li>
              <li class="relative">
                <a class="text-indigo-500 block w-full py-2 px-6 clear-both whitespace-nowrap hover:text-indigo-500 dark:hover:text-gray-300" href="credits.html">Credits</a>
              </li>
              <li class="relative">
                <a class="block w-full py-2 px-6 clear-both whitespace-nowrap hover:text-indigo-500 dark:hover:text-gray-300" href="changelog.html">Changelog</a>
              </li>
            </ul>
          </li>
              ...
              <li class="relative" x-data="{ open: false }" @keydown.escape.stop="open = false" @click.away="open = false">
               <a :class="{ 'text-indigo-500': open }" @click="open = !open" aria-haspopup="true" x-bind:aria-expanded="open" id="mobiledrop-91" class="block py-2.5 px-6 hover:text-indigo-500 dark:hover:text-gray-300" href="javascript:;">
                ...
                <ul class="block rounded rounded-t-none top-full z-50 ltr:pl-7 rtl:pr-7 py-0.5 ltr:text-left rtl:text-right mb-1 font-normal" x-show="open" x-transition:enter="transition-all duration-200 ease-out" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" role="menu" aria-orientation="vertical" aria-labelledby="mobiledrop-91">
                  <li class="relative">
                    <a class="block w-full py-2 px-6 clear-both whitespace-nowrap hover:text-indigo-500 dark:hover:text-gray-300" href="credits.html#">Item 1</a>
                  </li>
                  <li class="relative">
                    <a class="block w-full py-2 px-6 clear-both whitespace-nowrap hover:text-indigo-500 dark:hover:text-gray-300" href="credits.html#">Item 2</a>
                  </li>
                </ul>
              </li>
              <li class="relative" x-data="{ open: false }" @keydown.escape.stop="open = false" @click.away="open = false">
                ...
                <ul class="block rounded rounded-t-none top-full z-50 ltr:pl-7 rtl:pr-7 py-0.5 ltr:text-left rtl:text-right mb-1 font-normal" x-show="open" x-transition:enter="transition-all duration-200 ease-out" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" role="menu" aria-orientation="vertical" aria-labelledby="mobiledrop-92">
                  ...
                  <li class="relative" x-data="{ open: false }" @keydown.escape.stop="open = false" @click.away="open = false">
                    ...
                    <ul class="block rounded rounded-t-none top-full z-50 ltr:pl-7 rtl:pr-7 py-0.5 ltr:text-left rtl:text-right mb-1 font-normal" x-show="open" x-transition:enter="transition-all duration-200 ease-out" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" role="menu" aria-orientation="vertical" aria-labelledby="mobiledrop-93">
                      <li class="relative">
                        <a class="block w-full py-2 px-6 clear-both whitespace-nowrap hover:text-indigo-500 dark:hover:text-gray-300" href="credits.html#">Item 2.1</a>
                      </li>
                      <li class="relative">
                        <a class="block w-full py-2 px-6 clear-both whitespace-nowrap hover:text-indigo-500 dark:hover:text-gray-300" href="credits.html#">Item 2.2</a>
                      </li>
                    </ul>
                  </li>
                </ul>
        ...
        <div class="px-4 box-banner">
          <div class="my-8 p-4 text-center bg-gray-300 dark:bg-gray-700 bg-opacity-50 rounded-lg">
            ...
            <div class="grid">
              <a href="credits.html#" class="py-2 px-4 inline-block text-center mb-3 rounded leading-5 text-gray-100 bg-pink-500 border border-pink-500 hover:text-white hover:bg-pink-600 hover:ring-0 hover:border-pink-600 focus:bg-pink-600 focus:border-pink-600 focus:outline-none focus:ring-0" target="_blank">Download</a>
            </div>
          </div>
        </div><!-- end banner -->
      </div>
        ...
        <ul class="flex ltr:ml-auto rtl:mr-auto mt-2 mt-0">
              ...
              <nav id="mobile-nav" class="flex flex-col ltr:right-0 rtl:left-0 w-72 fixed top-0 bg-white dark:bg-gray-800 h-full overflow-auto z-40 scrollbars show" x-show="open" @click.away="open=false" x-description="Mobile menu" role="menu" aria-orientation="vertical" aria-labelledby="navbartoggle" x-transition:enter="transform transition-transform duration-300" x-transition:enter-start="ltr:translate-x-full rtl:-translate-x-full" x-transition:enter-end="translate-x-0" x-transition:leave="transform transition-transform duration-300" x-transition:leave-start="translate-x-0" x-transition:leave-end="ltr:translate-x-full rtl:-translate-x-full">
                ...
                <div class="pt-6 px-6">
                  <div x-data="{ open: true }" x-show="open" class="flex justify-between items-center relative bg-yellow-100 text-yellow-900 p-3 rounded-lg mb-4">
                    <div>
                      How to apply? please read the documentation on <a href="customize.html" class="underline font-semibold">Customize page</a>
                    </div>
          ...
          <li x-data="{ open: false }" class="relative">
            ...
            <div x-show="open" @click.away="open = false" x-transition:enter="transition-all duration-200 ease-out" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition-all duration-200 ease-in" x-transition:leave-start="transform opacity-100 scale-100" x-transition:leave-end="transform opacity-0 scale-95" class="w-72 origin-top-right absolute ltr:-right-36 md:ltr:right-0 rtl:-left-36 md:rtl:left-0 rounded top-full z-50 py-0.5 ltr:text-left rtl:text-right bg-white dark:bg-gray-800 border dark:border-gray-700 shadow-md" style="display: none;">
              <div class="p-3 font-normal border-b border-gray-200 dark:border-gray-700">
                <div class="relative">
                  ...
                  <div x-data="{ open: false }" class="absolute top-0 ltr:right-0 rtl:left-0">
                    ...
                    <a href="credits.html#" class="inline-block ltr:mr-2 rtl:ml-2" title="Mark all as read">
                    ...
                    <a href="credits.html#" class="inline-block ltr:mr-2 rtl:ml-2" title="New message">
              ...
              <div class="p-3 text-center font-normal">
                <a href="credits.html#" class="hover:underline">Show all Messages</a>
              </div>
            </div>
          </li>
          ...
          <li x-data="{ open: false }" class="relative">
            ...
            <div x-show="open" @click.away="open = false" x-transition:enter="transition-all duration-200 ease-out" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition-all duration-200 ease-in" x-transition:leave-start="transform opacity-100 scale-100" x-transition:leave-end="transform opacity-0 scale-95" class="w-72 origin-top-right absolute ltr:right-0 rtl:left-0 rounded top-full z-50 py-0.5 ltr:text-left rtl:text-right bg-white dark:bg-gray-800 border dark:border-gray-700 shadow-md" style="display: none;">
              <div class="p-3 font-normal border-b border-gray-200 dark:border-gray-700">
                <div class="relative">
                  ...
                  <div class="absolute top-0 ltr:right-0 rtl:left-0">
                    <a href="credits.html#" class="inline-block ltr:mr-2 rtl:ml-2" title="Clear all">
              ...
              <div class="max-h-60 overflow-y-auto scrollbars show">
                <a class="relative" href="credits.html#">
                  <div class="flex flex-wrap flex-row items-center border-b border-gray-200 dark:border-gray-700 dark:bg-gray-900 dark:bg-opacity-40 dark:hover:bg-opacity-20 py-2 hover:bg-gray-100 bg-gray-50">
                    <div class="flex-shrink max-w-full px-2 w-1/4 text-center">
              ...
              <div class="p-3 text-center font-normal">
                <a href="credits.html#" class="hover:underline">Show all Notifications</a>
              </div>
            </div>
          </li>
          ...
          <li x-data="{ open: false }" class="relative">
            ...
            <ul x-show="open" @click.away="open = false" x-transition:enter="transition-all duration-200 ease-out" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition-all duration-200 ease-in" x-transition:leave-start="transform opacity-100 scale-100" x-transition:leave-end="transform opacity-0 scale-95" class="origin-top-right absolute ltr:right-0 rtl:left-0 rounded top-full z-50 py-0.5 ltr:text-left rtl:text-right bg-white dark:bg-gray-800 border dark:border-gray-700 shadow-md" style="min-width:12rem;display: none;">
              <li class="relative">
                <div class="flex flex-wrap flex-row -mx-4 px-3 py-4 items-center">
                  ...
                  <div class="flex-shrink max-w-full px-4 w-2/3 ltr:pl-1 rtl:pr-1">
                    <div class="font-bold"><a href="credits.html#" class=" text-gray-800 dark:text-gray-300 hover:text-indigo-500">Ari Budin</a></div>
              ...
              <li class="relative">
                <a class="block w-full py-2 px-6 clear-both whitespace-nowrap hover:text-indigo-500" href="credits.html#">
              ...
              <div class="p-8 bg-white dark:bg-gray-800 rounded-lg shadow-lg h-full">
                <div class="relative">
                  <div class="mb-6">
                    ...
                    <p class="leading-relaxed font-light text-lg mx-auto pb-2">First, let us take this opportunity to thank all the creative minds for their great products and plugins.</p>
                  </div>
                  
                  <div id="premium-plugins" class="mb-8">
                    <h2 class="text-lg mb-2 font-semibold text-gray-800 dark:text-gray-300">Premium plugins</h2>
                    ...
                    <div class="tabless">
                      <table class="table-bordered w-full">
                        ...
                        <tbody>
                          <tr>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2"><span class="font-bold">Flickity</span></td>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2">Touch, responsive, flickable carousels</td>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2"><a class="text-indigo-500" href="https://flickity.metafizzy.co/" target="_blank">https://flickity.metafizzy.co/</a></td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
                  ...
                  <div id="free-plugins" class="mb-8">
                    <h2 class="text-lg mb-2 font-semibold text-gray-800 dark:text-gray-300">Free Plugins</h2>
                    ...
                    <div class="tabless">
                      <table class="table-bordered w-full">
                        ...
                        <tbody>
                          <tr>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2"><span class="font-bold">Tailwind Css</span></td>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2">Rapidly build modern websites without ever leaving your HTML</td>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2"><a class="text-indigo-500" href="https://tailwindcss.com/" target="_blank">https://tailwindcss.com/</a></td>
                          </tr>
                          <tr>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2"><span class="font-bold">Alpine JS</span></td>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2">Alpine.js offers you the reactive and declarative nature of big frameworks like Vue or React at a much lower cost</td>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2"><a class="text-indigo-500" href="https://github.com/alpinejs/alpine" target="_blank">https://github.com/alpinejs/alpine</a></td>
                          </tr>
                          <tr>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2"><span class="font-bold">Chart.js</span></td>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2">Simple yet flexible JavaScript charting for designers & developers.</td>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2"><a class="text-indigo-500" href="https://www.chartjs.org/" target="_blank">https://www.chartjs.org/</a></td>
                          </tr>
                          <tr>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2"><span class="font-bold">Dropzone</span></td>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2">Dropzone is an easy to use drag'n'drop library. It supports image previews and shows nice progress bars.</td>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2"><a class="text-indigo-500" href="https://github.com/dropzone/dropzone" target="_blank">https://github.com/dropzone/dropzone</a></td>
                          </tr>
                          <tr>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2"><span class="font-bold">Flatpickr</span></td>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2">lightweight, powerful javascript datetimepicker with no dependencies.</td>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2"><a class="text-indigo-500" href="https://github.com/flatpickr/flatpickr" target="_blank">https://github.com/flatpickr/flatpickr</a></td>
                          </tr>
                          <tr>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2"><span class="font-bold">FullCalendar</span></td>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2">Full-sized drag & drop event calendar.</td>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2"><a class="text-indigo-500" href="https://github.com/fullcalendar/fullcalendar" target="_blank">https://github.com/fullcalendar/fullcalendar</a></td>
                          </tr>
                          <tr>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2"><span class="font-bold">Glightbox</span></td>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2">Pure Javascript lightbox with mobile support. It can handle images, videos with autoplay, inline content and iframes</td>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2"><a class="text-indigo-500" href="https://github.com/biati-digital/glightbox" target="_blank">https://github.com/biati-digital/glightbox</a></td>
                          </tr>
                          <tr>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2"><span class="font-bold">Google Fonts</span></td>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2">Google Fonts is a library of over 800 libre licensed fonts, an interactive web directory for browsing the library, and APIs for conveniently using the fonts via CSS and Android.</td>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2"><a class="text-indigo-500" href="https://fonts.google.com/" target="_blank">https://fonts.google.com</a></td>
                          </tr>
                          <tr>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2"><span class="font-bold">Jsvectormap</span></td>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2">A lightweight Javascript library for creating interactive maps and pretty data visualization.</td>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2"><a class="text-indigo-500" href="https://github.com/themustafaomar/jsvectormap" target="_blank">https://github.com/themustafaomar/jsvectormap</a></td>
                          </tr>
                          <tr>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2"><span class="font-bold">Prism.js</span></td>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2">Prism is a lightweight, extensible syntax highlighter, built with modern web standards in mind. It's used in thousands of websites, including some of those you visit daily.</td>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2"><a class="text-indigo-500" href="http://prismjs.com" target="_blank">http://prismjs.com</a></td>
                          </tr>
                          <tr>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2"><span class="font-bold">Simple-DataTables</span></td>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2">DataTables but in Vanilla ES2018 JS</td>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2"><a class="text-indigo-500" href="https://github.com/fiduswriter/Simple-DataTables" target="_blank">https://github.com/fiduswriter/Simple-DataTables</a></td>
                          </tr>
                          <tr>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2"><span class="font-bold">SimpleMDE</span></td>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2">SimpleMDE is a simple, embeddable, and beautiful JS markdown editor</td>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2"><a class="text-indigo-500" href="https://simplemde.com/" target="_blank">https://simplemde.com/</a></td>
                          </tr>
                          <tr>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2"><span class="font-bold">Sweetalert2</span></td>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2">A beautiful, responsive, highly customizable and accessible (WAI-ARIA) replacement for JavaScript's popup boxes. Zero dependencies.</td>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2"><a class="text-indigo-500" href="https://github.com/sweetalert2/sweetalert2" target="_blank">https://github.com/sweetalert2/sweetalert2</a></td>
                          </tr>
                          <tr>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2"><span class="font-bold">Tagify</span></td>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2">Lightweight, efficient Tags input component in Vanilla JS / React / Angular / Vue</td>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2"><a class="text-indigo-500" href="https://github.com/yairEO/tagify" target="_blank">https://github.com/yairEO/tagify</a></td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
                  ...
                  <div id="free-design" class="mb-8">
                    <h2 class="text-lg mb-2 font-semibold text-gray-800 dark:text-gray-300">Free design sources</h2>
                    ...
                    <div class="tabless">
                      <table class="table-bordered w-full">
                        ...
                        <tbody>
                          <tr>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2"><span class="font-bold">Manypixels</span></td>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2">Browse to find the svg ilustrations that fit your needs and click to download. Use the on-the-fly color image generation to match your brand identity.</td>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2"><a class="text-indigo-500" href="https://www.manypixels.co/gallery/?page=1&style=flatline" target="_blank">https://www.manypixels.co/gallery/</a></td>
                          </tr>
                          <tr>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2"><span class="font-bold">Pexels</span></td>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2">The best free stock photos & videos shared by talented creators.</td>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2"><a class="text-indigo-500" href="https://www.pexels.com/" target="_blank">https://www.pexels.com/</a></td>
                          </tr>
                          <tr>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2"><span class="font-bold">Bootstrap Icons</span></td>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2">For the first time ever, Bootstrap has its own icon library.</td>
                            <td class="text-gray-500 border border-gray-200 dark:border-gray-700 px-4 py-2"><a class="text-indigo-500" href="https://icons.getbootstrap.com/" target="_blank">https://icons.getbootstrap.com/</a></td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
            ...
            <div class="flex-shrink max-w-full px-4 w-full md:w-1/2 text-center md:ltr:text-left md:rtl:text-right">
              <ul class="ltr:pl-0 rtl:pr-0">
                <li class="inline-block ltr:mr-3 rtl:ml-3">
                  <a class="hover:text-indigo-500" href="credits.html#">Support</a>
                </li>
                <li class="inline-block ltr:mr-3 rtl:ml-3">
                  <a class="hover:text-indigo-500" href="credits.html#">Help Center</a>
                </li>
                <li class="inline-block ltr:mr-3 rtl:ml-3">
                  <a class="hover:text-indigo-500" href="credits.html#">Privacy</a>
                </li>
                <li class="inline-block ltr:mr-3 rtl:ml-3">
                  <a class="hover:text-indigo-500" href="credits.html#">Terms of Service</a>
                </li>
              </ul>
            </div>

    ...
    <nav id="sidebar-menu" x-description="Mobile menu" x-bind:aria-expanded="open" :class="{ 'w-64 md:w-0': open, 'w-0 md:w-64': !(open) }" class="fixed w-64 transition-all duration-500 ease-in-out h-screen bg-white dark:bg-gray-800 shadow-sm">
      <div class="h-full overflow-y-auto scrollbars">
        ...
        <div class="mh-18 text-center py-5">
          <a href="product-detail.html#" class="relative">
        ...
        <!-- Sidebar menu -->
        <ul id="side-menu" x-data="{selected:2}" class="w-full float-none flex flex-col font-medium ltr:pl-1.5 rtl:pr-1.5">
          <!-- dropdown -->
          <li class="relative">
          ...
          <li class="relative">
            ...
            <ul x-show="selected == 2" x-transition:enter="transition-all duration-200 ease-out" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" class="block rounded rounded-t-none top-full z-50 ltr:pl-7 rtl:pr-7 py-0.5 ltr:text-left rtl:text-right mb-1 font-normal">
              <li class="relative">
                <a class="block w-full py-2 px-6 clear-both whitespace-nowrap hover:text-indigo-500 dark:hover:text-gray-300" href="product.html">Products</a>
              </li>
              <li class="relative">
                <a class="text-indigo-500 block w-full py-2 px-6 clear-both whitespace-nowrap hover:text-indigo-500 dark:hover:text-gray-300" href="product-detail.html">Product Details</a>
              </li>
              <li class="relative">
                <a class="block w-full py-2 px-6 clear-both whitespace-nowrap hover:text-indigo-500 dark:hover:text-gray-300" href="order.html">Orders</a>
              </li>
              <li class="relative">
                <a class="block w-full py-2 px-6 clear-both whitespace-nowrap hover:text-indigo-500 dark:hover:text-gray-300" href="order-detail.html">Order Details</a>
              </li>
              <li class="relative">
                <a class="block w-full py-2 px-6 clear-both whitespace-nowrap hover:text-indigo-500 dark:hover:text-gray-300" href="customers.html">Customers</a>
              </li>
              <li class="relative">
                <a class="block w-full py-2 px-6 clear-both whitespace-nowrap hover:text-indigo-500 dark:hover:text-gray-300" href="cart.html">Shopping Cart</a>
              </li>
              <li class="relative">
                <a class="block w-full py-2 px-6 clear-both whitespace-nowrap hover:text-indigo-500 dark:hover:text-gray-300" href="checkout.html">Checkout</a>
              </li>
              <li class="relative">
                <a class="block w-full py-2 px-6 clear-both whitespace-nowrap hover:text-indigo-500 dark:hover:text-gray-300" href="seller.html">Sellers</a>
              </li>
              <li class="relative">
                <a class="block w-full py-2 px-6 clear-both whitespace-nowrap hover:text-indigo-500 dark:hover:text-gray-300" href="invoice.html">Invoice</a>
              </li>
            </ul>
          </li>
              ...
              <li class="relative" x-data="{ open: false }" @keydown.escape.stop="open = false" @click.away="open = false">
               <a :class="{ 'text-indigo-500': open }" @click="open = !open" aria-haspopup="true" x-bind:aria-expanded="open" id="mobiledrop-91" class="block py-2.5 px-6 hover:text-indigo-500 dark:hover:text-gray-300" href="javascript:;">
                ...
                <ul class="block rounded rounded-t-none top-full z-50 ltr:pl-7 rtl:pr-7 py-0.5 ltr:text-left rtl:text-right mb-1 font-normal" x-show="open" x-transition:enter="transition-all duration-200 ease-out" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" role="menu" aria-orientation="vertical" aria-labelledby="mobiledrop-91">
                  <li class="relative">
                    <a class="block w-full py-2 px-6 clear-both whitespace-nowrap hover:text-indigo-500 dark:hover:text-gray-300" href="product-detail.html#">Item 1</a>
                  </li>
                  <li class="relative">
                    <a class="block w-full py-2 px-6 clear-both whitespace-nowrap hover:text-indigo-500 dark:hover:text-gray-300" href="product-detail.html#">Item 2</a>
                  </li>
                </ul>
              </li>
              <li class="relative" x-data="{ open: false }" @keydown.escape.stop="open = false" @click.away="open = false">
                ...
                <ul class="block rounded rounded-t-none top-full z-50 ltr:pl-7 rtl:pr-7 py-0.5 ltr:text-left rtl:text-right mb-1 font-normal" x-show="open" x-transition:enter="transition-all duration-200 ease-out" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" role="menu" aria-orientation="vertical" aria-labelledby="mobiledrop-92">
                  ...
                  <li class="relative" x-data="{ open: false }" @keydown.escape.stop="open = false" @click.away="open = false">
                    ...
                    <ul class="block rounded rounded-t-none top-full z-50 ltr:pl-7 rtl:pr-7 py-0.5 ltr:text-left rtl:text-right mb-1 font-normal" x-show="open" x-transition:enter="transition-all duration-200 ease-out" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" role="menu" aria-orientation="vertical" aria-labelledby="mobiledrop-93">
                      <li class="relative">
                        <a class="block w-full py-2 px-6 clear-both whitespace-nowrap hover:text-indigo-500 dark:hover:text-gray-300" href="product-detail.html#">Item 2.1</a>
                      </li>
                      <li class="relative">
                        <a class="block w-full py-2 px-6 clear-both whitespace-nowrap hover:text-indigo-500 dark:hover:text-gray-300" href="product-detail.html#">Item 2.2</a>
                      </li>
                    </ul>
                  </li>
                </ul>
        ...
        <div class="px-4 box-banner">
          <div class="my-8 p-4 text-center bg-gray-300 dark:bg-gray-700 bg-opacity-50 rounded-lg">
            ...
            <div class="grid">
              <a href="product-detail.html#" class="py-2 px-4 inline-block text-center mb-3 rounded leading-5 text-gray-100 bg-pink-500 border border-pink-500 hover:text-white hover:bg-pink-600 hover:ring-0 hover:border-pink-600 focus:bg-pink-600 focus:border-pink-600 focus:outline-none focus:ring-0" target="_blank">Download</a>
            </div>
          </div>
        </div><!-- end banner -->
      </div>
        ...
        <ul class="flex ltr:ml-auto rtl:mr-auto mt-2 mt-0">
          ...
          <li x-data="{ open: false }" class="relative">
            ...
            <div x-show="open" @click.away="open = false" x-transition:enter="transition-all duration-200 ease-out" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition-all duration-200 ease-in" x-transition:leave-start="transform opacity-100 scale-100" x-transition:leave-end="transform opacity-0 scale-95" class="w-72 origin-top-right absolute ltr:-right-36 md:ltr:right-0 rtl:-left-36 md:rtl:left-0 rounded top-full z-50 py-0.5 ltr:text-left rtl:text-right bg-white dark:bg-gray-800 border dark:border-gray-700 shadow-md" style="display: none;">
              <div class="p-3 font-normal border-b border-gray-200 dark:border-gray-700">
                <div class="relative">
                  ...
                  <div x-data="{ open: false }" class="absolute top-0 ltr:right-0 rtl:left-0">
                    ...
                    <a href="product-detail.html#" class="inline-block ltr:mr-2 rtl:ml-2" title="Mark all as read">
                    ...
                    <a href="product-detail.html#" class="inline-block ltr:mr-2 rtl:ml-2" title="New message">
              ...
              <div class="p-3 text-center font-normal">
                <a href="product-detail.html#" class="hover:underline">Show all Messages</a>
              </div>
            </div>
          </li>
          ...
          <li x-data="{ open: false }" class="relative">
            ...
            <div x-show="open" @click.away="open = false" x-transition:enter="transition-all duration-200 ease-out" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition-all duration-200 ease-in" x-transition:leave-start="transform opacity-100 scale-100" x-transition:leave-end="transform opacity-0 scale-95" class="w-72 origin-top-right absolute ltr:right-0 rtl:left-0 rounded top-full z-50 py-0.5 ltr:text-left rtl:text-right bg-white dark:bg-gray-800 border dark:border-gray-700 shadow-md" style="display: none;">
              <div class="p-3 font-normal border-b border-gray-200 dark:border-gray-700">
                <div class="relative">
                  ...
                  <div class="absolute top-0 ltr:right-0 rtl:left-0">
                    <a href="product-detail.html#" class="inline-block ltr:mr-2 rtl:ml-2" title="Clear all">
              ...
              <div class="max-h-60 overflow-y-auto scrollbars show">
                <a class="relative" href="product-detail.html#">
                  <div class="flex flex-wrap flex-row items-center border-b border-gray-200 dark:border-gray-700 dark:bg-gray-900 dark:bg-opacity-40 dark:hover:bg-opacity-20 py-2 hover:bg-gray-100 bg-gray-50">
                    <div class="flex-shrink max-w-full px-2 w-1/4 text-center">
              ...
              <div class="p-3 text-center font-normal">
                <a href="product-detail.html#" class="hover:underline">Show all Notifications</a>
              </div>
            </div>
          </li>
          ...
          <li x-data="{ open: false }" class="relative">
            ...
            <ul x-show="open" @click.away="open = false" x-transition:enter="transition-all duration-200 ease-out" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition-all duration-200 ease-in" x-transition:leave-start="transform opacity-100 scale-100" x-transition:leave-end="transform opacity-0 scale-95" class="origin-top-right absolute ltr:right-0 rtl:left-0 rounded top-full z-50 py-0.5 ltr:text-left rtl:text-right bg-white dark:bg-gray-800 border dark:border-gray-700 shadow-md" style="min-width:12rem;display: none;">
              <li class="relative">
                <div class="flex flex-wrap flex-row -mx-4 px-3 py-4 items-center">
                  ...
                  <div class="flex-shrink max-w-full px-4 w-2/3 ltr:pl-1 rtl:pr-1">
                    <div class="font-bold"><a href="product-detail.html#" class=" text-gray-800 dark:text-gray-300 hover:text-indigo-500">Ari Budin</a></div>
              ...
              <li class="relative">
                <a class="block w-full py-2 px-6 clear-both whitespace-nowrap hover:text-indigo-500" href="product-detail.html#">
                    ...
                    <a href="product-detail.html#">
                      <ul class="flex my-1">
                        <li class="ltr:mr-2 rtl:ml-2 text-yellow-400">
                          <!-- icon -->
                          <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 512 512"><path class="rating-svg" d="M394,480a16,16,0,0,1-9.39-3L256,383.76,127.39,477a16,16,0,0,1-24.55-18.08L153,310.35,23,221.2A16,16,0,0,1,32,192H192.38l48.4-148.95a16,16,0,0,1,30.44,0l48.4,149H480a16,16,0,0,1,9.05,29.2L359,310.35l50.13,148.53A16,16,0,0,1,394,480Z"></path></svg>
                    ...
                    <div x-data="{ tabs: 1 }">
                      ...
                      <div class="w-full pt-4">
                        <div x-show="tabs === 1">
                          ...
                          <ul>
                            <li class="py-2 border-b dark:border-gray-700 flex items-center justify-between"><span class="text-gray-500">Dimension:</span> 15.75 x 11.81 x 5.91 inches; 1.28 Pounds</li>
                            <li class="py-2 border-b dark:border-gray-700 flex items-center justify-between"><span class="text-gray-500">Model:</span> CK6360-100</li>
                            <li class="py-2 border-b dark:border-gray-700 flex items-center justify-between"><span class="text-gray-500">Department:</span> Women</li>
                            <li class="py-2 border-b dark:border-gray-700 flex items-center justify-between"><span class="text-gray-500">Date First Available:</span> June 29, 2021</li>
                            <li class="py-2 border-b dark:border-gray-700 flex items-center justify-between"><span class="text-gray-500">Color:</span> Blue, Green, Purple</li>
                          </ul>
                        </div>
                        <div x-show="tabs === 2">
                          ...
                          <div class="flex items-center text-center pb-6 border-b dark:border-gray-700">
                            ...
                            <div class="flex flex-col ltr:mr-3 rtl:ml-3">
                              <div class="flex items-center">
                                <div class="ltr:mr-2 rtl:ml-2">5 <svg xmlns="http://www.w3.org/2000/svg" class="inline-block text-yellow-400" width="18" height="18" fill="currentColor" viewBox="0 0 512 512"><path class="rating-svg" d="M394,480a16,16,0,0,1-9.39-3L256,383.76,127.39,477a16,16,0,0,1-24.55-18.08L153,310.35,23,221.2A16,16,0,0,1,32,192H192.38l48.4-148.95a16,16,0,0,1,30.44,0l48.4,149H480a16,16,0,0,1,9.05,29.2L359,310.35l50.13,148.53A16,16,0,0,1,394,480Z"></path></svg>
                                  <!-- <i class="fa fa-star"></i> --></div><div class="ltr:mr-2 rtl:ml-2 w-40 h-2 bg-gray-200 rounded-full mt-2"><div class="h-full text-center text-xs text-white bg-yellow-400 rounded-full" style="width:80%"></div></div><div class="ltr:mr-2 rtl:ml-2">(35)</div>
                              </div>
                              <div class="flex items-center">
                                <div class="ltr:mr-2 rtl:ml-2">4 <svg xmlns="http://www.w3.org/2000/svg" class="inline-block text-yellow-400" width="18" height="18" fill="currentColor" viewBox="0 0 512 512"><path class="rating-svg" d="M394,480a16,16,0,0,1-9.39-3L256,383.76,127.39,477a16,16,0,0,1-24.55-18.08L153,310.35,23,221.2A16,16,0,0,1,32,192H192.38l48.4-148.95a16,16,0,0,1,30.44,0l48.4,149H480a16,16,0,0,1,9.05,29.2L359,310.35l50.13,148.53A16,16,0,0,1,394,480Z"></path></svg>
                                  <!-- <i class="fa fa-star"></i> --></div><div class="ltr:mr-2 rtl:ml-2 w-40 h-2 bg-gray-200 rounded-full mt-2"><div class="h-full text-center text-xs text-white bg-yellow-400 rounded-full" style="width:20%"></div></div><div class="ltr:mr-2 rtl:ml-2">(7)</div>
                              </div>
                              <div class="flex items-center">
                                <div class="ltr:mr-2 rtl:ml-2">3 <svg xmlns="http://www.w3.org/2000/svg" class="inline-block text-yellow-400" width="18" height="18" fill="currentColor" viewBox="0 0 512 512"><path class="rating-svg" d="M394,480a16,16,0,0,1-9.39-3L256,383.76,127.39,477a16,16,0,0,1-24.55-18.08L153,310.35,23,221.2A16,16,0,0,1,32,192H192.38l48.4-148.95a16,16,0,0,1,30.44,0l48.4,149H480a16,16,0,0,1,9.05,29.2L359,310.35l50.13,148.53A16,16,0,0,1,394,480Z"></path></svg>
                                  <!-- <i class="fa fa-star"></i> --></div><div class="ltr:mr-2 rtl:ml-2 w-40 h-2 bg-gray-200 rounded-full mt-2"><div class="h-full text-center text-xs text-white bg-yellow-400 rounded-full" style="width:0%"></div></div><div class="ltr:mr-2 rtl:ml-2">(0)</div>
                              </div>
                              <div class="flex items-center">
                                <div class="ltr:mr-2 rtl:ml-2">2 <svg xmlns="http://www.w3.org/2000/svg" class="inline-block text-yellow-400" width="18" height="18" fill="currentColor" viewBox="0 0 512 512"><path class="rating-svg" d="M394,480a16,16,0,0,1-9.39-3L256,383.76,127.39,477a16,16,0,0,1-24.55-18.08L153,310.35,23,221.2A16,16,0,0,1,32,192H192.38l48.4-148.95a16,16,0,0,1,30.44,0l48.4,149H480a16,16,0,0,1,9.05,29.2L359,310.35l50.13,148.53A16,16,0,0,1,394,480Z"></path></svg>
                                  <!-- <i class="fa fa-star"></i> --></div><div class="ltr:mr-2 rtl:ml-2 w-40 h-2 bg-gray-200 rounded-full mt-2"><div class="h-full text-center text-xs text-white bg-yellow-400 rounded-full" style="width:0%"></div></div><div class="ltr:mr-2 rtl:ml-2">(0)</div>
                              </div>
                              <div class="flex items-center">
                                <div class="ltr:mr-2 rtl:ml-2">1 <svg xmlns="http://www.w3.org/2000/svg" class="inline-block text-yellow-400" width="18" height="18" fill="currentColor" viewBox="0 0 512 512"><path class="rating-svg" d="M394,480a16,16,0,0,1-9.39-3L256,383.76,127.39,477a16,16,0,0,1-24.55-18.08L153,310.35,23,221.2A16,16,0,0,1,32,192H192.38l48.4-148.95a16,16,0,0,1,30.44,0l48.4,149H480a16,16,0,0,1,9.05,29.2L359,310.35l50.13,148.53A16,16,0,0,1,394,480Z"></path></svg>
                                  <!-- <i class="fa fa-star"></i> --></div><div class="ltr:mr-2 rtl:ml-2 w-40 h-2 bg-gray-200 rounded-full mt-2"><div class="h-full text-center text-xs text-white bg-yellow-400 rounded-full" style="width:0%"></div></div><div class="ltr:mr-2 rtl:ml-2">(0)</div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="flex flex-col py-4 border-b dark:border-gray-700">
                            <div class="flex flex-row">
                              <h4 class="font-semibold mb-1 ltr:mr-2 rtl:ml-2">Original product</h4>
                            ...
                            <p class="text-gray-500 mb-1">Trusted seller, original product, fast response and fast shipping</p>
                          ...
                          <div class="flex flex-col py-4 border-b dark:border-gray-700">
                            ...
                            <p class="text-xs text-gray-500 mb-2">by Jane <span class="ml-1">Oct 10,2022</span></p>
                          </div>
                          <!-- review list -->
                          <div class="flex flex-col py-4 border-b dark:border-gray-700">
                            <div class="flex flex-row">
                            ...
                            <p class="text-xs text-gray-500 mb-2">by Thomas <span class="ml-1">Oct 10,2022</span></p>
                          </div>
                          <!-- review list -->
                          <div class="flex flex-col py-4 border-b dark:border-gray-700">
                            <div class="flex flex-row">
                        ...
                        <div x-show="tabs === 3">
                            ...
                            <div x-data="{open:false}">
                              ...
                              <div x-show="open">
                                <form class="flex flex-wrap flex-row mt-4">
                                  <div class="mr-4">
                                    <label for="formGroupExampleInput" class="hidden">Your question</label>
                                  ...
                                  <div class="flex-shrink">
                                    <button type="submit" class="py-2 px-4 inline-block text-center rounded leading-5 text-gray-100 bg-indigo-500 border border-indigo-500 hover:text-white hover:bg-blue-800 hover:ring-0 hover:border-blue-800 focus:bg-blue-800 focus:border-blue-800 focus:outline-none focus:ring-0">Submit question</button>
                                  </div>
                                </form>
                              </div>
                            </div>
                          ...
                          <div class="flex flex-col p-4 mb-4 rounded-md border dark:border-gray-700">
                            <h5 class="mb-1 font-bold">Question: when is it ready for red color?</h5>
                            <p class="text-xs mb-2">by Jesicca <span class="italic">Oct 12, 2021</span></p>

                            <p class="mb-1"><span class="font-bold">Answer:</span> I'm very sorry, Sis, until now, the red Nike Women's Race Running Shoe product has not been able to be ordered because of the enthusiasm and interest of buyers so that the product stock runs out. Please click "Notify Me" to receive a notification when the product is ready again. Thank you</p>
                            <p class="text-xs mb-2">by CS <span class="italic">Oct 12, 2021</span></p>
                          </div>
                          <!-- Question -->
                          <div class="flex flex-col p-4 mb-4 rounded-md border dark:border-gray-700">
                            <h5 class="mb-1 font-bold">Question: when is it ready for red color?</h5>
            ...
            <div class="flex-shrink max-w-full px-4 w-full md:w-1/2 text-center md:ltr:text-left md:rtl:text-right">
              <ul class="ltr:pl-0 rtl:pr-0">
                <li class="inline-block ltr:mr-3 rtl:ml-3">
                  <a class="hover:text-indigo-500" href="product-detail.html#">Support</a>
                </li>
                <li class="inline-block ltr:mr-3 rtl:ml-3">
                  <a class="hover:text-indigo-500" href="product-detail.html#">Help Center</a>
                </li>
                <li class="inline-block ltr:mr-3 rtl:ml-3">
                  <a class="hover:text-indigo-500" href="product-detail.html#">Privacy</a>
                </li>
                <li class="inline-block ltr:mr-3 rtl:ml-3">
                  <a class="hover:text-indigo-500" href="product-detail.html#">Terms of Service</a>
                </li>
              </ul>
            </div>

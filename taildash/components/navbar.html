        ...
        <ul id="side-menu" x-data="{selected:6}" class="w-full float-none flex flex-col font-medium ltr:pl-1.5 rtl:pr-1.5">
          ...
          <li class="relative">
            ...
            <ul x-show="selected == 6" x-transition:enter="transition-all duration-200 ease-out" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" class="block rounded rounded-t-none top-full z-50 ltr:pl-7 rtl:pr-7 py-0.5 ltr:text-left rtl:text-right mb-1 font-normal">
              ...
              <li class="relative">
                <a class="block w-full py-2 px-6 clear-both whitespace-nowrap hover:text-indigo-500 dark:hover:text-gray-300" href="buttons.html">Buttons</a>
              </li>
              <li class="relative">
              ...
              <li class="relative">
                <a class="text-indigo-500 block w-full py-2 px-6 clear-both whitespace-nowrap hover:text-indigo-500 dark:hover:text-gray-300" href="navbar.html">Navbar</a>
              </li>
              <li class="relative">
              ...
              <li class="relative" x-data="{ open: false }" @keydown.escape.stop="open = false" @click.away="open = false">
               <a :class="{ 'text-indigo-500': open }" @click="open = !open" aria-haspopup="true" x-bind:aria-expanded="open" id="mobiledrop-91" class="block py-2.5 px-6 hover:text-indigo-500 dark:hover:text-gray-300" href="javascript:;">
                ...
                <ul class="block rounded rounded-t-none top-full z-50 ltr:pl-7 rtl:pr-7 py-0.5 ltr:text-left rtl:text-right mb-1 font-normal" x-show="open" x-transition:enter="transition-all duration-200 ease-out" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" role="menu" aria-orientation="vertical" aria-labelledby="mobiledrop-91">
                  <li class="relative">
                    <a class="block w-full py-2 px-6 clear-both whitespace-nowrap hover:text-indigo-500 dark:hover:text-gray-300" href="navbar.html#">Item 1</a>
                  </li>
                  <li class="relative">
                    <a class="block w-full py-2 px-6 clear-both whitespace-nowrap hover:text-indigo-500 dark:hover:text-gray-300" href="navbar.html#">Item 2</a>
                  </li>
                </ul>
              </li>
              <li class="relative" x-data="{ open: false }" @keydown.escape.stop="open = false" @click.away="open = false">
                ...
                <ul class="block rounded rounded-t-none top-full z-50 ltr:pl-7 rtl:pr-7 py-0.5 ltr:text-left rtl:text-right mb-1 font-normal" x-show="open" x-transition:enter="transition-all duration-200 ease-out" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" role="menu" aria-orientation="vertical" aria-labelledby="mobiledrop-92">
                  ...
                  <li class="relative" x-data="{ open: false }" @keydown.escape.stop="open = false" @click.away="open = false">
                    ...
                    <ul class="block rounded rounded-t-none top-full z-50 ltr:pl-7 rtl:pr-7 py-0.5 ltr:text-left rtl:text-right mb-1 font-normal" x-show="open" x-transition:enter="transition-all duration-200 ease-out" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" role="menu" aria-orientation="vertical" aria-labelledby="mobiledrop-93">
                      <li class="relative">
                        <a class="block w-full py-2 px-6 clear-both whitespace-nowrap hover:text-indigo-500 dark:hover:text-gray-300" href="navbar.html#">Item 2.1</a>
                      </li>
                      <li class="relative">
                        <a class="block w-full py-2 px-6 clear-both whitespace-nowrap hover:text-indigo-500 dark:hover:text-gray-300" href="navbar.html#">Item 2.2</a>
                      </li>
                    </ul>
                  </li>
                </ul>
    ...
    <div x-bind:aria-expanded="open" :class="{ 'ltr:ml-64 ltr:-mr-64 md:ltr:ml-0 md:ltr:mr-0 rtl:mr-64 rtl:-ml-64 md:rtl:mr-0 md:rtl:ml-0': open, 'ltr:ml-0 ltr:mr-0 md:ltr:ml-64 rtl:mr-0 rtl:ml-0 md:rtl:mr-64': !(open) }" class="flex flex-col ltr:ml-64 rtl:mr-64 min-h-screen transition-all duration-500 ease-in-out">
        ...
        <ul class="flex ltr:ml-auto rtl:mr-auto mt-2 mt-0">
          ...
          <li x-data="{ open: false }" class="relative">
            ...
            <div x-show="open" @click.away="open = false" x-transition:enter="transition-all duration-200 ease-out" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition-all duration-200 ease-in" x-transition:leave-start="transform opacity-100 scale-100" x-transition:leave-end="transform opacity-0 scale-95" class="w-72 origin-top-right absolute ltr:-right-36 md:ltr:right-0 rtl:-left-36 md:rtl:left-0 rounded top-full z-50 py-0.5 ltr:text-left rtl:text-right bg-white dark:bg-gray-800 border dark:border-gray-700 shadow-md" style="display: none;">
              <div class="p-3 font-normal border-b border-gray-200 dark:border-gray-700">
                <div class="relative">
                  ...
                  <div x-data="{ open: false }" class="absolute top-0 ltr:right-0 rtl:left-0">
                    ...
                    <a href="navbar.html#" class="inline-block ltr:mr-2 rtl:ml-2" title="Mark all as read">
                    ...
                    <a href="navbar.html#" class="inline-block ltr:mr-2 rtl:ml-2" title="New message">
              ...
              <div class="p-3 text-center font-normal">
                <a href="navbar.html#" class="hover:underline">Show all Messages</a>
              </div>
            </div>
          </li>
          ...
          <li x-data="{ open: false }" class="relative">
            ...
            <div x-show="open" @click.away="open = false" x-transition:enter="transition-all duration-200 ease-out" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition-all duration-200 ease-in" x-transition:leave-start="transform opacity-100 scale-100" x-transition:leave-end="transform opacity-0 scale-95" class="w-72 origin-top-right absolute ltr:right-0 rtl:left-0 rounded top-full z-50 py-0.5 ltr:text-left rtl:text-right bg-white dark:bg-gray-800 border dark:border-gray-700 shadow-md" style="display: none;">
              <div class="p-3 font-normal border-b border-gray-200 dark:border-gray-700">
                <div class="relative">
                  ...
                  <div class="absolute top-0 ltr:right-0 rtl:left-0">
                    <a href="navbar.html#" class="inline-block ltr:mr-2 rtl:ml-2" title="Clear all">
              ...
              <div class="max-h-60 overflow-y-auto scrollbars show">
                <a class="relative" href="navbar.html#">
                  <div class="flex flex-wrap flex-row items-center border-b border-gray-200 dark:border-gray-700 dark:bg-gray-900 dark:bg-opacity-40 dark:hover:bg-opacity-20 py-2 hover:bg-gray-100 bg-gray-50">
                    <div class="flex-shrink max-w-full px-2 w-1/4 text-center">
              ...
              <div class="p-3 text-center font-normal">
                <a href="navbar.html#" class="hover:underline">Show all Notifications</a>
              </div>
            </div>
          </li>
          ...
          <li x-data="{ open: false }" class="relative">
            ...
            <ul x-show="open" @click.away="open = false" x-transition:enter="transition-all duration-200 ease-out" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition-all duration-200 ease-in" x-transition:leave-start="transform opacity-100 scale-100" x-transition:leave-end="transform opacity-0 scale-95" class="origin-top-right absolute ltr:right-0 rtl:left-0 rounded top-full z-50 py-0.5 ltr:text-left rtl:text-right bg-white dark:bg-gray-800 border dark:border-gray-700 shadow-md" style="min-width:12rem;display: none;">
              <li class="relative">
                <div class="flex flex-wrap flex-row -mx-4 px-3 py-4 items-center">
                  ...
                  <div class="flex-shrink max-w-full px-4 w-2/3 ltr:pl-1 rtl:pr-1">
                    <div class="font-bold"><a href="navbar.html#" class=" text-gray-800 dark:text-gray-300 hover:text-indigo-500">Ari Budin</a></div>
              ...
              <li class="relative">
                <a class="block w-full py-2 px-6 clear-both whitespace-nowrap hover:text-indigo-500" href="navbar.html#">
      ...
      <main class="pt-20 -mt-2">
          	...
          	<div class="flex-shrink max-w-full px-4 w-full mb-6">
	              ...
	              <div class="relative">
	              	<div class="mb-6">
			              <p class="leading-relaxed font-light text-lg mx-auto pb-2">Responsive navigation header, the navbar with link and dropdown menu.</p>
			            </div>

			            <div id="navbar-offcanvas" class="mb-8">
			              <h2 class="text-lg mb-2 font-semibold text-gray-800 dark:text-gray-300">Navbar with Offcanvas menu</h2>
			                  ...
			                  <div class="container mx-auto px-4 xl:max-w-6xl ">
			                    ...
			                    <div class="lg:hidden fixed w-full h-full inset-0 z-50" id="mobile-menu" x-description="Mobile menu" x-show="open" style="display: none;">
			                      ...
			                      <nav id="mobile-nav" class="flex flex-col right-0 w-64 fixed top-0 py-4 bg-white dark:bg-gray-900 h-full overflow-auto z-40" x-show="open" @click.away="open=false" x-description="Mobile menu" x-show="open" role="menu" aria-orientation="vertical" aria-labelledby="navbartoggle" x-transition:enter="transform transition-transform duration-300" x-transition:enter-start="translate-x-full" x-transition:enter-end="translate-x-0" x-transition:leave="transform transition-transform duration-300" x-transition:leave-start="translate-x-0" x-transition:leave-end="translate-x-full">
			                          ...
			                          <div class="mb-4">
			                            <nav class="relative flex flex-wrap items-center justify-between">
			                              <ul id="side-menu" class="w-full float-none flex flex-col">
			                                <li class="relative">
			                                  <a href="navbar.html#" class="block py-3 px-4 hover:text-indigo-700 focus:text-indigo-700">Home</a>
			                                </li>

			                                <!-- Insert dropdown mobile Offcanvas menu -->

			                                <li class="relative">
			                                  <a href="navbar.html#" class="block py-3 px-4 hover:text-indigo-700 focus:text-indigo-700">About</a>
			                                </li>
			                                <li class="relative">
			                                  <a href="navbar.html#" class="block py-3 px-4 hover:text-indigo-700 focus:text-indigo-700">Services</a>
			                                </li>
			                                <li class="relative">
			                                  <a href="navbar.html#" class="block py-3 px-4 hover:text-indigo-700 focus:text-indigo-700">Support</a>
			                                </li>
			                              </ul>
			                            </nav>
			                          </div>
			                        ...
			                        <div class="mt-5 text-center">
			                          <p>Copyright <a href="navbar.html#">Taildash</a> - All right reserved</p>
			                        </div>
			                      </nav>
			                    </div><!-- End Mobile menu -->
			                    ...
			                    <div class="hidden lg:flex lg:flex-row lg:flex-nowrap lg:items-center lg:justify-between lg:mt-0" id="desktp-menu">
			                      ...
			                      <ul class="flex flex-col lg:mx-auto mt-2 lg:flex-row lg:mt-0">
			                        <li class="relative">
			                          <!-- active -->
			                          <a class="group block py-3 lg:py-7 px-6 text-indigo-500 hover:text-indigo-600 focus:text-indigo-600" href="navbar.html#">
			                        ...
			                        <li class="relative">
			                          <a class="group block py-3 lg:py-7 px-6 hover:text-indigo-700 focus:text-indigo-700" href="navbar.html#">
			              ...
			              <p class="mt-6 mb-3">If you want to use navbar fixed, please add <code class="text-pink-700">fixed</code> class in <code class="text-pink-700">flex flex-nowrap lg:flex-start</code> (navbar parent)</p>
			              <p class="mb-3">Don't forget to add padding top 20 in <code class="text-pink-700">body</code> like this <code class="text-pink-700">&lt;body class="pt-20 font-sans text-base font-normal text-gray-700"&gt;</code></p>
			              <p class="mb-6"><span class="text-red-700 font-bold uppercase">Note:</span> You can insert <a href="dropdowns.html#dropdown-desktop" class="text-indigo-700">dropdown desktop</a> and <a href="dropdowns.html#dropdown-offcanvas" class="text-indigo-700">dropdown Offcanvas</a> in this navbar.</p>
			            </div>
			            
			            <div id="navbar-dropdowns" class="mb-8">
			              <h2 class="text-lg mb-2 font-semibold text-gray-800 dark:text-gray-300">Navbar with dropdown menu</h2>
			                  ...
			                  <div class="container mx-auto px-4 xl:max-w-6xl ">
			                    ...
			                    <div class="flex flex-col lg:hidden" id="mobile-menu" x-description="Mobile menu" x-show="open" style="display: none;">
			                      ...
			                      <ul class="flex flex-col mt-2">
			                        <li class="relative">
			                          <!-- active -->
			                          <a class="group block py-3 lg:py-7 px-0 text-indigo-500 hover:text-indigo-600 focus:text-indigo-600" href="navbar.html#">
			                            <span class="absolute bottom-4 left-1/2 transform -translate-x-1/2 w-6 h-0.5 bg-indigo-600 transition duration-700 ease-in-out opacity-100"></span>
			                            Home
			                          </a>
			                        </li>
			                        ...
			                        <li class="relative">
			                          <a class="group block py-3 lg:py-7 px-0 hover:text-indigo-600 focus:text-indigo-600" href="navbar.html#">
			                      ...
			                      <div class="grid text-center my-4">
			                        <a class="py-2 px-4 -ml-1 rounded leading-5 text-sm text-gray-100 bg-indigo-500 border border-indigo-500 hover:text-white hover:bg-indigo-600 hover:ring-0 hover:border-indigo-600 focus:bg-indigo-600 focus:border-indigo-600 focus:outline-none focus:ring-0" target="_blank" rel="noopener" href="navbar.html#">
			                          <svg xmlns="http://www.w3.org/2000/svg" class="inline mr-1" width="1.2rem" height="1.2rem" fill="currentColor" viewBox="0 0 512 512"><circle cx="176" cy="416" r="16" style="fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:32px"/><circle cx="400" cy="416" r="16" style="fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:32px"/><polyline points="48 80 112 80 160 352 416 352" style="fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:32px"/><path d="M160,288H409.44a8,8,0,0,0,7.85-6.43l28.8-144a8,8,0,0,0-7.85-9.57H128" style="fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:32px"/></svg> Buy Now
			                        </a>
			                      </div>
			                    </div><!-- end mobile menu -->
			                    ...
			                    <div class="hidden lg:flex lg:flex-row lg:flex-nowrap lg:items-center lg:justify-between lg:mt-0" id="desktp-menu">
			                      ...
			                      <ul class="flex flex-col lg:mx-auto mt-2 lg:flex-row lg:mt-0">
			                        ...
			                        <li class="relative">
			                          <a class="group block py-3 lg:py-7 px-6 hover:text-indigo-600 focus:text-indigo-600" href="navbar.html#">
			                            <span class="absolute bottom-4 left-1/2 transform -translate-x-1/2 w-6 h-0.5 bg-indigo-600 transition duration-700 ease-in-out opacity-0 group-hover:opacity-100"></span>
			                            About
			                          </a>
			                        </li>
			              ...
			              <p class="mt-6 mb-3">If you want to use navbar fixed, please add <code class="text-pink-700">fixed</code> class in <code class="text-pink-700">flex flex-nowrap lg:flex-start</code> (navbar parent)</p>
			              <p class="mb-3">Don't forget to add padding top 20 in <code class="text-pink-700">body</code> like this <code class="text-pink-700">&lt;body class="pt-20 font-sans text-base font-normal text-gray-700"&gt;</code></p>
			              <p class="mb-6"><span class="text-red-700 font-bold uppercase">Note:</span> You can insert <a href="dropdowns.html#dropdown-desktop" class="text-indigo-500">dropdown desktop</a> and <a href="dropdowns.html#dropdown-mobiles" class="text-indigo-500">dropdown mobile</a> in this navbar.</p>
			            </div>
	              </div>
							</div>
						</div>

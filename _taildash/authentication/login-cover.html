...
<body class="font-sans text-base font-normal text-gray-600 dark:text-gray-400 dark:bg-gray-800">
            ...
            <div class="p-6 sm:p-8">
              <form id="login-form">
                <div class="text-center">
                  <a class="py-2 text-2xl" href="login-cover.html#">
                ...
                <div class="mb-6">
                  ...
                  <input name="email" id="inputemail" class="w-full leading-5 relative py-2 px-4 rounded text-gray-800 bg-white border border-gray-300 overflow-x-auto focus:outline-none focus:border-gray-400 focus:ring-0dark:text-gray-300 dark:bg-gray-700 dark:border-gray-700 dark:focus:border-gray-600" value="" aria-label="email" type="email" required="">
                </div>
                <div class="mb-6">
                  <div class="flex flex-wrap flex-row">
                  ...
                  <input id="inputpass" class="w-full leading-5 relative py-2 px-4 rounded text-gray-800 bg-white border border-gray-300 overflow-x-auto focus:outline-none focus:border-gray-400 focus:ring-0dark:text-gray-300 dark:bg-gray-700 dark:border-gray-700 dark:focus:border-gray-600" aria-label="password" type="password" value="" required="">
                </div>
                <div class="mb-6">
                ...
                <div class="grid">
                  <button type="submit" class="py-2 px-4 inline-block text-center rounded leading-5 text-gray-100 bg-indigo-500 border border-indigo-500 hover:text-white hover:bg-indigo-600 hover:ring-0 hover:border-indigo-600 focus:bg-indigo-600 focus:border-indigo-600 focus:outline-none focus:ring-0">
              ...
              <div class="mt-4">
                ...
                <div class="text-center mb-6 sm:space-x-4">
                  <a class="p-2 block sm:inline-block rounded lg:rounded-full leading-5 text-gray-100 bg-indigo-900 border border-indigo-900 hover:text-white hover:opacity-90 hover:ring-0 hover:border-indigo-900 focus:bg-indigo-900 focus:border-indigo-800 focus:outline-none focus:ring-0 mb-3" href="login-cover.html#">
                  ...
                  <a class="p-2 block sm:inline-block rounded lg:rounded-full leading-5 text-gray-100 bg-indigo-400 border border-indigo-400 hover:text-white hover:bg-indigo-600 hover:ring-0 hover:border-indigo-600 focus:bg-indigo-600 focus:border-indigo-600 focus:outline-none focus:ring-0 mb-3" href="login-cover.html#">
                ...
                <p class="text-center mb-0">Don't have an account? <a class="hover:text-indigo-500" href="register-cover.html">Register</a></p>
              </div>
            </div>
          </div>
        </div>
  ...
  <div x-data="{ open: false }" class="relative">
    <a href="javascript:;" class="fixed bottom-4 ltr:right-4 rtl:left-4 text-gray-500 block py-3 px-4 flex text-sm rounded-full focus:outline-none" aria-controls="mobile-canvas" @click="open = !open" aria-expanded="false" x-bind:aria-expanded="open.toString()">
      <span class="sr-only">Customizer</span>
      <svg x-description="Icon closed" x-state:on="Menu open" x-state:off="Menu closed" class="block h-6 w-6 animate-spin-slow" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">

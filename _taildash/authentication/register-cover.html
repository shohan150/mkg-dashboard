...
<body class="font-sans text-base font-normal text-gray-600 dark:text-gray-400 dark:bg-gray-800">
  ...
  <div class="bg-gray-100 dark:bg-gray-900 dark:bg-opacity-40" style="background: url(../src/img/blog/blog_4.jpg);background-repeat: no-repeat;background-size: cover;background-attachment: fixed;">
      ...
      <span class="fixed bg-gray-900 bg-opacity-70 w-full h-full inset-x-0 top-0"></span>
	      ...
	      <!-- login form -->
	      <div class="max-w-full w-full px-6 sm:px-12 bg-white dark:bg-gray-800 shadow-lg z-40">
	        <div class="relative">
	          <div class="p-6 sm:p-8">
	            <form id="login-form">
	            	<div class="text-center">
		              <a class="py-2 text-2xl" href="register-cover.html#">
	              ...
	              <div class="mb-4">
                  <label for="inputname" class="inline-block mb-2">Full Name</label>
	                <input name="name" id="inputname" class="w-full leading-5 relative py-2 px-4 rounded text-gray-800 bg-white border border-gray-300 overflow-x-auto focus:outline-none focus:border-gray-400 focus:ring-0 dark:text-gray-300 dark:bg-gray-700 dark:border-gray-700 dark:focus:border-gray-600" value="" aria-label="text" type="text" required="">
	              </div>
	              <div class="mb-4">
	              ...
	              <div class="my-6">
                    ...
                    <label class="ltr:ml-2 rtl:mr-2" for="terms">
                      I agree to the <a href="register-cover.html#">Terms and Conditions</a>
                    </label>
                  </div>
	              <div class="grid">
	            ...
	            <div class="mt-4">
	              ...
	              <div class="text-center mb-6 sm:space-x-4">
	                <a class="p-2 block sm:inline-block rounded lg:rounded-full leading-5 text-gray-100 bg-indigo-900 border border-indigo-900 hover:text-white hover:opacity-90 hover:ring-0 hover:border-indigo-900 focus:bg-indigo-900 focus:border-indigo-800 focus:outline-none focus:ring-0 mb-3" href="register-cover.html#">
	                ...
	                <a class="p-2 block sm:inline-block rounded lg:rounded-full leading-5 text-gray-100 bg-indigo-500 border border-indigo-500 hover:text-white hover:bg-indigo-600 hover:ring-0 hover:border-indigo-600 focus:bg-indigo-600 focus:border-indigo-600 focus:outline-none focus:ring-0 mb-3" href="register-cover.html#">
	              ...
	              <p class="text-center mb-4">Already have an account?  <a class="hover:text-indigo-500" href="login-cover.html">Login</a></p>
	            </div>
	          </div>
	        </div>
	      </div>

      ...
      <div class="h-full overflow-y-auto scrollbars">
        ...
        <ul id="side-menu" x-data="{selected:2}" class="w-full float-none flex flex-col font-medium ltr:pl-1.5 rtl:pr-1.5">
          ...
          <li class="relative">
            ...
            <ul x-show="selected == 2" x-transition:enter="transition-all duration-200 ease-out" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" class="block rounded rounded-t-none top-full z-50 ltr:pl-7 rtl:pr-7 py-0.5 ltr:text-left rtl:text-right mb-1 font-normal">
              ...
              <li class="relative">
                <a class="block w-full py-2 px-6 clear-both whitespace-nowrap hover:text-indigo-500 dark:hover:text-gray-300" href="product-detail.html">Product Details</a>
              </li>
              <li class="relative">
              ...
              <li class="relative">
                <a class="text-indigo-500 block w-full py-2 px-6 clear-both whitespace-nowrap hover:text-indigo-500 dark:hover:text-gray-300" href="checkout.html">Checkout</a>
              </li>
              <li class="relative">
              ...
              <li class="relative" x-data="{ open: false }" @keydown.escape.stop="open = false" @click.away="open = false">
               <a :class="{ 'text-indigo-500': open }" @click="open = !open" aria-haspopup="true" x-bind:aria-expanded="open" id="mobiledrop-91" class="block py-2.5 px-6 hover:text-indigo-500 dark:hover:text-gray-300" href="javascript:;">
                ...
                <ul class="block rounded rounded-t-none top-full z-50 ltr:pl-7 rtl:pr-7 py-0.5 ltr:text-left rtl:text-right mb-1 font-normal" x-show="open" x-transition:enter="transition-all duration-200 ease-out" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" role="menu" aria-orientation="vertical" aria-labelledby="mobiledrop-91">
                  <li class="relative">
                    <a class="block w-full py-2 px-6 clear-both whitespace-nowrap hover:text-indigo-500 dark:hover:text-gray-300" href="checkout.html#">Item 1</a>
                  </li>
                  <li class="relative">
                    <a class="block w-full py-2 px-6 clear-both whitespace-nowrap hover:text-indigo-500 dark:hover:text-gray-300" href="checkout.html#">Item 2</a>
                  </li>
                </ul>
              </li>
              <li class="relative" x-data="{ open: false }" @keydown.escape.stop="open = false" @click.away="open = false">
                ...
                <ul class="block rounded rounded-t-none top-full z-50 ltr:pl-7 rtl:pr-7 py-0.5 ltr:text-left rtl:text-right mb-1 font-normal" x-show="open" x-transition:enter="transition-all duration-200 ease-out" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" role="menu" aria-orientation="vertical" aria-labelledby="mobiledrop-92">
                  ...
                  <li class="relative" x-data="{ open: false }" @keydown.escape.stop="open = false" @click.away="open = false">
                    ...
                    <ul class="block rounded rounded-t-none top-full z-50 ltr:pl-7 rtl:pr-7 py-0.5 ltr:text-left rtl:text-right mb-1 font-normal" x-show="open" x-transition:enter="transition-all duration-200 ease-out" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" role="menu" aria-orientation="vertical" aria-labelledby="mobiledrop-93">
                      <li class="relative">
                        <a class="block w-full py-2 px-6 clear-both whitespace-nowrap hover:text-indigo-500 dark:hover:text-gray-300" href="checkout.html#">Item 2.1</a>
                      </li>
                      <li class="relative">
                        <a class="block w-full py-2 px-6 clear-both whitespace-nowrap hover:text-indigo-500 dark:hover:text-gray-300" href="checkout.html#">Item 2.2</a>
                      </li>
                    </ul>
                  </li>
                </ul>
        ...
        <div class="px-4 box-banner">
          <div class="my-8 p-4 text-center bg-gray-300 dark:bg-gray-700 bg-opacity-50 rounded-lg">
            ...
            <div class="grid">
              <a href="checkout.html#" class="py-2 px-4 inline-block text-center mb-3 rounded leading-5 text-gray-100 bg-pink-500 border border-pink-500 hover:text-white hover:bg-pink-600 hover:ring-0 hover:border-pink-600 focus:bg-pink-600 focus:border-pink-600 focus:outline-none focus:ring-0" target="_blank">Download</a>
            </div>
          </div>
        </div><!-- end banner -->
      </div>
        ...
        <ul class="flex ltr:ml-auto rtl:mr-auto mt-2 mt-0">
          ...
          <li x-data="{ open: false }" class="relative">
            ...
            <div x-show="open" @click.away="open = false" x-transition:enter="transition-all duration-200 ease-out" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition-all duration-200 ease-in" x-transition:leave-start="transform opacity-100 scale-100" x-transition:leave-end="transform opacity-0 scale-95" class="w-72 origin-top-right absolute ltr:-right-36 md:ltr:right-0 rtl:-left-36 md:rtl:left-0 rounded top-full z-50 py-0.5 ltr:text-left rtl:text-right bg-white dark:bg-gray-800 border dark:border-gray-700 shadow-md" style="display: none;">
              <div class="p-3 font-normal border-b border-gray-200 dark:border-gray-700">
                <div class="relative">
                  ...
                  <div x-data="{ open: false }" class="absolute top-0 ltr:right-0 rtl:left-0">
                    ...
                    <a href="checkout.html#" class="inline-block ltr:mr-2 rtl:ml-2" title="Mark all as read">
                    ...
                    <a href="checkout.html#" class="inline-block ltr:mr-2 rtl:ml-2" title="New message">
              ...
              <div class="p-3 text-center font-normal">
                <a href="checkout.html#" class="hover:underline">Show all Messages</a>
              </div>
            </div>
          </li>
          ...
          <li x-data="{ open: false }" class="relative">
            ...
            <div x-show="open" @click.away="open = false" x-transition:enter="transition-all duration-200 ease-out" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition-all duration-200 ease-in" x-transition:leave-start="transform opacity-100 scale-100" x-transition:leave-end="transform opacity-0 scale-95" class="w-72 origin-top-right absolute ltr:right-0 rtl:left-0 rounded top-full z-50 py-0.5 ltr:text-left rtl:text-right bg-white dark:bg-gray-800 border dark:border-gray-700 shadow-md" style="display: none;">
              <div class="p-3 font-normal border-b border-gray-200 dark:border-gray-700">
                <div class="relative">
                  ...
                  <div class="absolute top-0 ltr:right-0 rtl:left-0">
                    <a href="checkout.html#" class="inline-block ltr:mr-2 rtl:ml-2" title="Clear all">
              ...
              <div class="max-h-60 overflow-y-auto scrollbars show">
                <a class="relative" href="checkout.html#">
                  <div class="flex flex-wrap flex-row items-center border-b border-gray-200 dark:border-gray-700 dark:bg-gray-900 dark:bg-opacity-40 dark:hover:bg-opacity-20 py-2 hover:bg-gray-100 bg-gray-50">
                    <div class="flex-shrink max-w-full px-2 w-1/4 text-center">
              ...
              <div class="p-3 text-center font-normal">
                <a href="checkout.html#" class="hover:underline">Show all Notifications</a>
              </div>
            </div>
          </li>
          ...
          <li x-data="{ open: false }" class="relative">
            ...
            <ul x-show="open" @click.away="open = false" x-transition:enter="transition-all duration-200 ease-out" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition-all duration-200 ease-in" x-transition:leave-start="transform opacity-100 scale-100" x-transition:leave-end="transform opacity-0 scale-95" class="origin-top-right absolute ltr:right-0 rtl:left-0 rounded top-full z-50 py-0.5 ltr:text-left rtl:text-right bg-white dark:bg-gray-800 border dark:border-gray-700 shadow-md" style="min-width:12rem;display: none;">
              <li class="relative">
                <div class="flex flex-wrap flex-row -mx-4 px-3 py-4 items-center">
                  ...
                  <div class="flex-shrink max-w-full px-4 w-2/3 ltr:pl-1 rtl:pr-1">
                    <div class="font-bold"><a href="checkout.html#" class=" text-gray-800 dark:text-gray-300 hover:text-indigo-500">Ari Budin</a></div>
              ...
              <li class="relative">
                <a class="block w-full py-2 px-6 clear-both whitespace-nowrap hover:text-indigo-500" href="checkout.html#">
        ...
        <div class="mx-auto p-2">
          ...
          <div class="flex flex-wrap flex-row">
                ...
                <div class="w-full overflow-x-auto">
                  <div id="Accordione" x-data="{selected:0}">
                    ...
                    <div class="relative flex flex-wrap flex-col shadow mb-4 bg-white dark:bg-gray-800">
                      <div class="py-2 px-4 border-b border-gray-200 mb-0 bg-gray-100 dark:bg-gray-900 dark:bg-opacity-20 dark:border-gray-800" id="HeadingOnee">
                        <div class="d-grid mb-0">
                          <button class="py-4 px-6 w-full rounded-md leading-5 font-medium flex px-0 justify-between focus:outline-none focus:ring-0"  @click="selected !== 0 ? selected = 0 : selected = null">
                        ...
                        <div class="flex-1 p-6 bg-gray-100 dark:bg-gray-900 bg-opacity-60 dark:bg-opacity-20">
                          <form class="flex flex-wrap flex-row -mx-4">
                            <div class="flex-shrink max-w-full px-4 w-full md:w-1/2 mb-6">
                              ...
                              <input type="text" class="w-full leading-5 relative py-2 px-4 rounded text-gray-800 bg-white border border-gray-300 overflow-x-auto focus:outline-none focus:border-gray-400 focus:ring-0 dark:text-gray-300 dark:bg-gray-700 dark:border-gray-700 dark:focus:border-gray-600" id="inputname">
                            </div>
                            <div class="flex-shrink max-w-full px-4 w-full md:w-1/2 mb-6">
                            ...
                            <div class="flex-shrink max-w-full px-4 w-full md:w-1/2 mb-6">
                              ...
                              <input type="text" class="w-full leading-5 relative py-2 px-4 rounded text-gray-800 bg-white border border-gray-300 overflow-x-auto focus:outline-none focus:border-gray-400 focus:ring-0 dark:text-gray-300 dark:bg-gray-700 dark:border-gray-700 dark:focus:border-gray-600" id="inputphone">
                            </div>
                            <div class="flex-shrink max-w-full px-4 w-full md:w-1/2 mb-6">
                              <label for="inputemail" class="inline-block mb-2">Email</label>
                              <input type="email" class="w-full leading-5 relative py-2 px-4 rounded text-gray-800 bg-white border border-gray-300 overflow-x-auto focus:outline-none focus:border-gray-400 focus:ring-0 dark:text-gray-300 dark:bg-gray-700 dark:border-gray-700 dark:focus:border-gray-600" id="inputemail">
                            </div>
                            <div class="flex-shrink max-w-full px-4 w-full md:w-1/2 mb-6">
                              <label for="inputCountry" class="inline-block mb-2">Country</label>
                              <select id="inputCountry" class="inline-block w-full leading-5 relative py-2 pl-3 pr-8 rounded text-gray-800 bg-white border border-gray-300 overflow-x-auto focus:outline-none focus:border-gray-400 focus:ring-0 dark:text-gray-300 dark:bg-gray-700 dark:border-gray-700 dark:focus:border-gray-600 select-caret appearance-none">
                            ...
                            <div class="flex-shrink max-w-full px-4 w-full mb-6">
                              <label class="flex items-center">
                                <input type="checkbox" name="checked-demo" value="1" class="form-checkbox h-5 w-5 ltr:mr-3 rtl:ml-3 text-indigo-500 dark:bg-gray-700 border border-gray-300 dark:border-gray-700 rounded focus:outline-none">
                                <span>Ship to different address ?</span>
                              </label>
                            </div>
                            <div class="flex-shrink max-w-full px-4 w-full">
                              <button type="submit" class="py-2 px-4 inline-block text-center mb-3 rounded py-2 px-5 inline-block text-center rounded leading-5 text-gray-100 bg-indigo-500 border border-indigo-500 hover:text-gray-100 hover:bg-indigo-600 hover:ring-0 hover:border-indigo-600 focus:bg-indigo-600 focus:border-indigo-600 focus:outline-none focus:ring-0">Continue <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="inline-block ltr:ml-2 rtl:mr-2 bi bi-arrow-right" viewBox="0 0 16 16">
                    ...
                    <!-- list -->
                    <div class="relative flex flex-wrap flex-col shadow mb-4 bg-white dark:bg-gray-800">
                      <div class="py-2 px-4 border-b border-gray-200 mb-0 bg-gray-100 dark:bg-gray-900 dark:bg-opacity-20 dark:border-gray-800" id="HeadingTwoe">
                        <div class="d-grid mb-0">
                          <button class="py-4 px-6 w-full rounded-md leading-5 font-medium flex px-0 justify-between focus:outline-none focus:ring-0" @click="selected !== 1 ? selected = 1 : selected = null">
                        ...
                        <div class="flex-1 p-6 bg-gray-100 dark:bg-gray-900 bg-opacity-60 dark:bg-opacity-20">
                          ...
                          <div class="flex flex-wrap flex-row mb-6">
                            <label class="py-3 flex-shrink max-w-full px-4 w-full md:w-1/2 cursor-pointer">
                              <input type="radio" class="form-checkbox h-5 w-5 text-indigo-500 dark:bg-gray-700 border border-gray-300 dark:border-gray-700 rounded focus:outline-none rounded-full" name="shippingAddress" value="home" checked="">
                            ...
                            <label class="py-3 flex-shrink max-w-full px-4 w-full md:w-1/2 cursor-pointer">
                              <input type="radio" class="form-checkbox h-5 w-5 text-indigo-500 dark:bg-gray-700 border border-gray-300 dark:border-gray-700 rounded focus:outline-none rounded-full" name="shippingAddress" value="office">
                          ...
                          <div class="flex flex-wrap flex-row mb-6 text-gray-700">
                            <label class="p-3 bg-green-100 flex-shrink max-w-full px-4 w-full md:w-1/3 cursor-pointer">
                              <input type="radio" class="form-checkbox h-5 w-5 text-indigo-500 dark:bg-gray-700 border border-gray-300 dark:border-gray-700 rounded focus:outline-none rounded-full" name="shippingMethod" value="free" checked="">
                            ...
                            <label class="p-3 bg-green-200 flex-shrink max-w-full px-4 w-full md:w-1/3 cursor-pointer">
                              <input type="radio" class="form-checkbox h-5 w-5 text-indigo-500 dark:bg-gray-700 border border-gray-300 dark:border-gray-700 rounded focus:outline-none rounded-full" name="shippingMethod" value="standart">
                            ...
                            <label class="p-3 bg-green-300 flex-shrink max-w-full px-4 w-full md:w-1/3 cursor-pointer">
                              <input type="radio" class="form-checkbox h-5 w-5 text-indigo-500 dark:bg-gray-700 border border-gray-300 dark:border-gray-700 rounded focus:outline-none rounded-full" name="shippingMethod" value="express">
                    ...
                    <!-- list -->
                    <div class="relative flex flex-wrap flex-col shadow mb-4 bg-white dark:bg-gray-800">
                      <div class="py-2 px-4 border-b border-gray-200 mb-0 bg-gray-100 dark:bg-gray-900 dark:bg-opacity-20 dark:border-gray-800" id="HeadingThreee">
                        <div class="d-grid mb-0">
                          <button class="py-4 px-6 w-full rounded-md leading-5 font-medium flex px-0 justify-between focus:outline-none focus:ring-0" @click="selected !== 2 ? selected = 2 : selected = null">
            ...
            <div class="flex-shrink max-w-full px-4 w-full lg:w-1/3 mb-6">
              <div class="p-6 bg-white dark:bg-gray-800 rounded shadow-lg mb-6">
                <div class="relative">
                  <table class="table-auto w-full ltr:text-left rtl:text-right text-gray-600">
                    ...
                    <tbody class="bg-gray-100 dark:bg-gray-900 bg-opacity-60 dark:bg-opacity-20 text-sm">
                    ...
                    <tfoot class="bg-gray-100 dark:bg-gray-900 bg-opacity-60 dark:bg-opacity-20 text-sm">
                      <tr class="border-b dark:border-gray-700">
            ...
            <div class="flex-shrink max-w-full px-4 w-full md:w-1/2 text-center md:ltr:text-left md:rtl:text-right">
              <ul class="ltr:pl-0 rtl:pr-0">
                <li class="inline-block ltr:mr-3 rtl:ml-3">
                  <a class="hover:text-indigo-500" href="checkout.html#">Support</a>
                </li>
                <li class="inline-block ltr:mr-3 rtl:ml-3">
                  <a class="hover:text-indigo-500" href="checkout.html#">Help Center</a>
                </li>
                <li class="inline-block ltr:mr-3 rtl:ml-3">
                  <a class="hover:text-indigo-500" href="checkout.html#">Privacy</a>
                </li>
                <li class="inline-block ltr:mr-3 rtl:ml-3">
                  <a class="hover:text-indigo-500" href="checkout.html#">Terms of Service</a>
                </li>
              </ul>
            </div>

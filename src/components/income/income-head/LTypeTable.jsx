...
export default function LTypeTable({ handleEdit, handleDelete }) {
    ...
    const leaveTypes = ["Tution Fee", "Exam Fee", "Fine", "Annual Fee"];
            ...
            <table className="w-full text-textGray text-sm leading-8">
                <thead className="border-b-2 bg-bgBlue">
                    <tr>
                        ...
                        <th className="w-7/12">{t("module.income.incomeHeadTitle")}</th>
                        <th className="w-4/12">{t("module.income.actions")}</th>
                    </tr>
                </thead>

...
export default function TeacherSubjectAssign() {
    return (
      ...
      <div className="flex items-center">
        <label className="w-24 sm:w-28 md:w-32">Teacher Name: </label>
        <select
          id=""
          name=""
          defaultValue="select"
        ...
        >
         <option value="select" disabled="true">Select Teacher</option>
      ...
      <h3 className="text-primary text-lg font-semibold mt-6 mb-2">Select Class</h3>
      {/* show all subjects */}
      ...
      <h3 className="text-primary text-lg font-semibold mt-6 mb-2">Select Subject</h3>
      {/* show all subjects */}

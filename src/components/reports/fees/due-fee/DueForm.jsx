   ...
   return (
      <form className="md:flex gap-7 items-center justify-between mb-2">
         <div className="flex items-center gap-2 md:w-5/12 my-2">
            ...
            >
               <option value="Nursary Jaba">{t("module.report.nursaryJaba")}</option>
               <option value="Nursary Golap">{t("module.report.nursaryGolap")}</option>
               <option value="One Jaba">{t("module.report.oneJaba")}</option>
            </select>
         </div>

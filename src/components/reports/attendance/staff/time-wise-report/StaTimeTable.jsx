...
export default function StaTimeTable() {
   const dummyData = [
      {
        id: "001",
        name: "John Doe",
   ...
   <div className="border my-6 rounded shadow-md overflow-x-scroll">
      <table className="w-full text-textGray text-center leading-6 sm:leading-8">
         ...
         <tr>
            ...
            <th className="w-4/12 min-w-32">Name</th>
            <th className="w-1/12">Roll</th>
            <th className="w-2/12 min-w-16">Status</th>
            <th className="w-2/12 min-w-20">In Time</th>
            <th className="w-2/12 min-w-20">Out Time</th>
         </tr>
         </thead>

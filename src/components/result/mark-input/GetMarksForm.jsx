...
export default function GetMarksForm() {
    ...
    return (
        <form className="sm:flex space-y-2 gap-2 sm:gap-3 md:gap-5 lg:gap-7 items-end mt-2 sm:mt-0 mb-2">
            ...
            <div className="space-y-1 w-full sm:w-1/4 pb-2 sm:pb-0">
                <label>{t('module.result.selectSubject')}</label>
                <select
                    id=""
                    name=""
                ...
                >
                    ...
                    <option value="English">{t('module.result.english')}</option>
                    <option value="Math">{t('module.result.math')}</option>
                    <option value="History">{t('module.result.history')}</option>
                </select>
            </div>

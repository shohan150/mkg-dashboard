...
export default function Notices() {
  ...
  return (
    <div className="bg-white col-span-1 order-3 sm:order-2 lg:order-3 rounded-md">
      {/* component heading */}
      ...
      <div className="flex justify-end p-2">
        <button className="bg-tertiary text-white text-sm font-medium shadow py-1 px-4 rounded">
          View All
        </button>
      </div>
    </div>
